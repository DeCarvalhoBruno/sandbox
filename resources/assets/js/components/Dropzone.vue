    ...
    <div class="row">
        ...
        <div class="col preview-actions">
            ...
            <div class="row">
                ...
                <button type="button" class="btn btn-sm btn-info action-edit-file" hidden="hidden" data-toggle="collapse" data-target=".div-media-update" aria-expanded="false" aria-controls="div-media-update" title="${this.$t(
