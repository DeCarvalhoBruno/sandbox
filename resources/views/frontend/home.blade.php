...
<body>
    ...
    <header>
        <div class="container">
            ...
            <ul class="nav nav-main d-none d-lg-flex">
                ...
                <li class="nav-item dropdown dropdown-hover">
                    <a class="nav-link dropdown-toggle forwardable" data-toggle="dropdown" href="shop-categ"
                        ...
                        <div class="row">
                            <div class="col-lg-3 border-right">
                                <div class="list-group list-group-flush list-group-no-border list-group-sm">
                                    <a href="shop-grid.html" class="list-group-item list-group-item-action"><strong>Link1</strong></a>
    ...
    <div id="app" style="min-height: 2500px !important;height: 2500px">
        @section('content')
            <div class="container">
