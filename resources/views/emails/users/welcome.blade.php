...
<div style="background:#a42227;background-color:#a42227;Margin:0px auto;max-width:600px;">
    ...
    <table
            ...
            style="background:#a42227;background-color:#a42227;width:100%;"
    >
        <tbody>
        <tr>
            <td
                    style="border-bottom:8px solid #2f6591;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:10px;padding-left:0px;padding-right:0px;padding-top:10px;text-align:center;vertical-align:top;"
            >
                <!--[if mso | IE]>
...
<div style="background:#efd6ce;background-color:#efd6ce;Margin:0px auto;max-width:600px;">
    ...
    <table
            align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            style="background:#efd6ce;background-color:#efd6ce;width:100%;"
    >
        <tbody>
        <tr>
            <td
            ...
            >
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td
                                align="center" style="vertical-align:top;width:600px;"
                        >
                <![endif]-->
...
<div style="background:#f15a24;background-color:#f15a24;Margin:0px auto;max-width:600px;">

    <table
            align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            style="background:#f15a24;background-color:#f15a24;width:100%;"
    >
        <tbody>
        <tr>
            <td
                    style="border-top:8px solid #2f6591;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:22px;padding-left:0px;padding-right:0px;padding-top:25px;text-align:center;vertical-align:top;"
            >
                <!--[if mso | IE]>
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    ...
                    >
                        ...
                        <tr>
                            <td
                                    ...
                                    style="font-size:0px;padding:20px 30px;word-break:break-word;"
                            >
                                ...
                                >
                                    <tr>
                                        <td
                                                align="center" bgcolor="#2f6591" role="presentation"
                ...
                >
                    ...
                    >
                        ...
                        <tr>
                            <td
                                    align="center"
                                    style="font-size:0px;padding:10px 25px;padding-top:0;padding-right:0px;padding-bottom:5px;padding-left:0px;word-break:break-word;"
                            >
                                ...
                                >
                                    {!! trans('email.welcome.origin', ['name'=>$user_name, 'email'=>$email]) !!}
