...
<div>
    ...
    <div style="background:#ffffff;background-color:#ffffff;Margin:0px auto;max-width:600px;">
        ...
        >
            ...
            <tr>
                <td
                        style="direction:ltr;font-size:0px;padding:15px 0;padding-bottom:15px;padding-left:0px;padding-right:0px;padding-top:15px;text-align:center;vertical-align:top;"
                >
                    <!--[if mso | IE]>
                                    ...
                                    >
                                        ...
                                        <tr>
                                            <td style="width:300px;">
                                                ...
                                                <a
                                                        href="{!! route_i18n('home') !!}"
                                                        target="_blank"
                                                >

                                                    <img
                                                            alt="Logo" height="auto"
                                                            src="{!! $message->embed(media_entity_root_path('img','site','logo.png')) !!}"
