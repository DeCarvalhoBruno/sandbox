...
return [
    'welcome' => [
        'subject' => 'Naraki - Your registration',
        'title' => 'You registered on our website. We are pleased.',
        ...
        'body3' => 'Before using your account, please make sure to click on the \'activate account\' button below.',
        'cta' => 'Activate Account'
    ],
    'password_reset' => [
        'subject' => 'Naraki - Resetting your password',
    ...
    'origin' => 'This email originates from the naraki platform and is addressed to :name (:email)',
];