...
mix.js('resources/assets/frontend/spa/js/app.js', 'js/app.js')
  .sass('resources/assets/frontend/spa/sass/app.scss', 'css/app.css')
  .sourceMaps()
...
mix.webpackConfig({
  ...
  resolve: {
    ...
    alias: {
      '~': path.join(__dirname, './resources/assets/frontend/spa/js'),
